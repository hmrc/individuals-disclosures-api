...
class CreateMarriageAllowanceRequestDataBodySpec extends UnitSpec {
  ...
  "CreateMarriageAllowanceBody" when {
    "read from valid JSON" should {
      "produce the expected CreateMarriageAllowanceBody object" in {
        rawJson.as[CreateMarriageAllowanceRequestBody] shouldBe requestBodyModel
      }
    }
    ...
    "read from invalid JSON" should {
      "produce a JsError" in {
        ...
        invalidJson.validate[CreateMarriageAllowanceRequestBody] shouldBe a[JsError]
      }
    }
