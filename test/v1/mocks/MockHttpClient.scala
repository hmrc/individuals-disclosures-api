...
trait MockHttpClient extends MockFactory {
  ...
  object MockedHttpClient {
    def get[T](url: String, config: HeaderCarrier.Config, requiredHeaders: (String, String)*): CallHandler[Future[T]] = {
      (mockHttpClient
    ...
    def delete[T](url: String, config: HeaderCarrier.Config, requiredHeaders: (String, String)*): CallHandler[Future[T]] = {
      (mockHttpClient
    ...
    def put[I, T](url: String, config: HeaderCarrier.Config, body: I, requiredHeaders: (String, String)*): CallHandler[Future[T]] = {
      (mockHttpClient
